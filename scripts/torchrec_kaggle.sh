...
torchx run -s local_cwd -cfg log_dir=log/torchrec_kaggle/w1_16k dist.ddp -j 1x1 --script baselines/dlrm_main.py -- \
    ...
    --learning_rate 1. --batch_size 16384 --profile_dir "tensorboard_log/torchrec_kaggle/w1_16k"
