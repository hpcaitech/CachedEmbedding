...
#    --in_memory_binary_criteo_path avazu_sample --embedding_dim 128 --pin_memory \
#    --over_arch_layer_sizes "1024,1024,512,256,1" --dense_arch_layer_sizes "512,256,128" --shuffle_batches \
#    --learning_rate 5e-2 --batch_size 16384 --use_sparse_embed_grad --use_cache --use_freq --cache_lines 1 \
#    --profile_dir "tensorboard_log/cache"  --buffer_size 0 --use_overlap
